...
public class ExecuteWorker {
    ...
    private static final String candidateGroup = "ExecuteCreateWorker";
    ...
    private static final String taskKey = "ExecuteCreate";

    public void executeCreateWorker() {
        ...
        synchronized (LOCKER) {
            ...
            try {
                ...
                taskService.setVariable(task.getId(), "createSuccess", true);
